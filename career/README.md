...
하지만 실제 채용공고를 보면 이 기술들은 하나의 운영 흐름으로 연결됩니다.
...
4. `portfolio-checklist.md`로 현재 GitHub 포트폴리오 상태를 점검합니다.
...
```text
Cloud Native Career Guide는 초보자가 클라우드 네이티브 학습 내용을 실제 직무, 자격증, 포트폴리오와 연결하도록 돕는 커리어 문서입니다.
```
